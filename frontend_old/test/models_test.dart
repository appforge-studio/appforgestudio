...
import 'package:appforge/utilities/component_factory.dart';
...
void main() {
  group('Component Models', () {
    test('ContainerComponent serialization round-trip', () {
      final original = ComponentFactory.createComponent(ComponentType.container, 10.0, 20.0);
    ...
    test('TextComponent serialization round-trip', () {
      final original = ComponentFactory.createComponent(ComponentType.text, 15.0, 25.0);
      final json = original.toJson();
      final restored = ComponentFactory.fromJson(json);
    ...
    test('ImageComponent serialization round-trip', () {
      final original = ComponentFactory.createComponent(ComponentType.image, 30.0, 40.0);
      final json = original.toJson();
      final restored = ComponentFactory.fromJson(json);
    ...
    test('JSON schema generation', () {
      final container = ComponentFactory.createComponent(ComponentType.container, 0.0, 0.0);
      final text = ComponentFactory.createComponent(ComponentType.text, 0.0, 0.0);
      final image = ComponentFactory.createComponent(ComponentType.image, 0.0, 0.0);
  ...
  group('Component Repositioning', () {
    ...
    test('updateComponentPosition constrains within canvas boundaries', () {
      ...
      final component = ComponentFactory.createComponent(ComponentType.container, 50.0, 50.0);
